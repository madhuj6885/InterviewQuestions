...
Expected: 7
Received: {Symbol(async_id_symbol): 3867, Symbol(trigger_async_id_symbol): 3715, Symbol(kResourceStore): undefined}
    at C:\Users\Admin\OneDrive\Desktop\Amazon\tests\PrintingAllOptions.spec.js:23:32
```
...
- table:
  - rowgroup:
    - row "Name Network (Mbps) CPU (%) Disk (MB/s) Memory (MB)":
      ...
      - cell "Memory (MB)"
  - rowgroup:
    - row "Internet Explorer 3.1 Mbps 3.7% 0.42 MB/s 33.5 MB":
      - cell "Internet Explorer"
      - cell "3.1 Mbps"
      - cell "3.7%"
      - cell "0.42 MB/s"
      - cell "33.5 MB"
    - row "System 4.9 Mbps 3.1% 0.83 MB/s 41.5 MB":
      - cell "System"
      - cell "4.9 Mbps"
      - cell "3.1%"
      - cell "0.83 MB/s"
      - cell "41.5 MB"
    - row "Chrome 2.3 Mbps 0.4% 0.95 MB/s 86.7 MB":
      - cell "Chrome"
      - cell "2.3 Mbps"
      - cell "0.4%"
      - cell "0.95 MB/s"
      - cell "86.7 MB"
    - row "Firefox 6.5 Mbps 8.0% 0.51 MB/s 89.3 MB":
      - cell "Firefox"
      - cell "6.5 Mbps"
      - cell "8.0%"
      - cell "0.51 MB/s"
...
```ts
  ...
  18 |     // webtables
  19 |
  20 |     const rows = await page.locator("[name='BookTable'] tbody tr");
  21 |         console.log(await rows.count());
  22 |
> 23 |     await expect(rows.count()).toBe(7);
     |                                ^ Error: expect(received).toBe(expected) // Object.is equality
  24 |
  25 |     await page.waitForTimeout(5000);
  26 |     // console.log(allOptions.length);
  27 |     
  28 |
  29 |
  30 |
